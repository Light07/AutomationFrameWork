...
class Generate_Report():
        def __init__(self):
            ...
            if not os.path.exists(os.path.join(self.test_base,"test_report.html")):
        ...
        def generate_report(self, test_suites):
            ...
            runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title="TestReport",description="Below report show the results of auto run")
